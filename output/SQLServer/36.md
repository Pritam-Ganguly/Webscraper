...
In this article, I will discuss the **Left Outer Join in SQL Server** with Examples. Please read our previous article discussing [**SQL Server Inner Join**](https://dotnettutorials.net/lesson/inner-join-in-sql-server/) with Examples. You will understand the following pointers in detail at the end of this article.
...
5. **How can only retrieve non-matching rows from the left table in SQL Server?**
...
![What is Left Outer Join in SQL Server?](data:image/svg+xml,%3Csvg%20xmlns=%22http://www.w3.org/2000/svg%22%20width=%22433%22%20height=%22347%22%3E%3C/svg%3E "What is Left Outer Join in SQL Server?")
...
![How to implement Left Outer Join in SQL Server?](data:image/svg+xml,%3Csvg%20xmlns=%22http://www.w3.org/2000/svg%22%20width=%22477%22%20height=%22269%22%3E%3C/svg%3E "How to implement Left Outer Join in SQL Server?")
...
![Example to Understand SQL Server Left Outer Join](data:image/svg+xml,%3Csvg%20xmlns=%22http://www.w3.org/2000/svg%22%20width=%22786%22%20height=%22337%22%3E%3C/svg%3E "Example to Understand SQL Server Left Outer Join")
...
![Left Outer Join Example in SQL Server](data:image/svg+xml,%3Csvg%20xmlns=%22http://www.w3.org/2000/svg%22%20width=%22472%22%20height=%22195%22%3E%3C/svg%3E "Left Outer Join Example in SQL Server")
...
![Joining three Tables in SQL Server using Left Join](data:image/svg+xml,%3Csvg%20xmlns=%22http://www.w3.org/2000/svg%22%20width=%22429%22%20height=%22132%22%3E%3C/svg%3E "Joining three Tables in SQL Server using Left Join")
